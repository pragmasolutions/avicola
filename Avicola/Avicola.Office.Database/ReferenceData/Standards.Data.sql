...
SELECT  '86D41158-364A-4801-8975-05C9B1CEBD3C', N'Peso corporal', 'Kg', '939E6F2D-8001-448A-88E2-FEC280FBB055', 'BC083A29-845F-45E9-BF41-5A68F480CA73', 1, 'AVG', GETDATE(), 0 WHERE NOT EXISTS (SELECT 1 FROM [dbo].[Standard] WHERE Id = '86D41158-364A-4801-8975-05C9B1CEBD3C')
...
INSERT INTO [dbo].[Standard] ([Id], [Name], [MeasureUnity], [DataLoadTypeId], [StandardTypeId], [AllowDecimal], [AggregateOperation], [CreatedDate], [IsDeleted])
SELECT  '42F12739-8F64-4E20-B08A-750B0D9B9E96', N'Consumo de Alimento', 'Kg', 'C4D05E89-69FB-42F7-8F6A-15C8BC130377', '7DCE6982-E172-4AFD-9D4D-FADDBA8EBA35', 1, 'SUM', GETDATE(), 0 WHERE NOT EXISTS (SELECT 1 FROM [dbo].[Standard] WHERE Id = '42F12739-8F64-4E20-B08A-750B0D9B9E96')
...
INSERT INTO [dbo].[Standard] ([Id], [Name], [MeasureUnity], [DataLoadTypeId], [StandardTypeId], [AllowDecimal], [AggregateOperation], [CreatedDate], [IsDeleted])
SELECT  'A755ACAB-4A3C-45FF-B90C-6B851E16A713', N'Peso del huevo', 'Kg', '939E6F2D-8001-448A-88E2-FEC280FBB055', '7DCE6982-E172-4AFD-9D4D-FADDBA8EBA35', 1, 'AVG', GETDATE(), 0 WHERE NOT EXISTS (SELECT 1 FROM [dbo].[Standard] WHERE Id = 'A755ACAB-4A3C-45FF-B90C-6B851E16A713')
